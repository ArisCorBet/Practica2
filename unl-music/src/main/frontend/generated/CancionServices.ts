...
async function listaGeneroCombo_1(init?: EndpointRequestInit_1): Promise<Array<Record<string, unknown> | undefined> | undefined> { return client_1.call("CancionServices", "listaGeneroCombo", {}, init); }
...
export { create_1 as create, listaAlbumCombo_1 as listaAlbumCombo, listaGeneroCombo_1 as listaGeneroCombo, listAll_1 as listAll, listCancion_1 as listCancion, listTipo_1 as listTipo, update_1 as update };
